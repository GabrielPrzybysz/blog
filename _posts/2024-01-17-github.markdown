...
description: "How GitHub's file hosting feature allows uploading arbitrary files — including XSS payloads — behind legitimate GitHub.com URLs, bypassing WAF protections by design."
