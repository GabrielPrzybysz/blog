...
tags: [c, malware, ddos]
description: "perxibes (Gabriel Przybysz) explores the inner workings of the Mirai botnet malware — its C-based architecture, DDoS capabilities, and what makes it fascinating from a security research perspective."
---
