...
description: "A Wireshark forensic walkthrough of Ann's Bad AIM, a classic network forensics puzzle: tracing IM conversations, recovering a transferred file, and reconstructing the evidence chain."
...
![image-1](/assets/images/2-ann.png)
...
![image-2](/assets/images/3-ann.png)
...
![Untitled - Frame 1](/assets/images/4-ann.jpg)
