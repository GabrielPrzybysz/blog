...
description: "Gabriel Przybysz (perxibes) walks through a network forensics investigation using Wireshark to uncover a secret agent leaking corporate data via instant messaging."
---
