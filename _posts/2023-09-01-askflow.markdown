...
description: "A whitebox penetration test of AskFlow, a Go web application, covering DoS via request exhaustion, IDOR authentication bypass, SSRF via image injection, and unauthenticated email API exposure."
...
![askflowintro](/assets/images/ask-1.png)
...
![askflowintro](/assets/images/ask-2.png)
...
![askflowintro](/assets/images/ask-3.png)
...
![askflowintro](/assets/images/ask-4.png)
...
![askflowintro](/assets/images/ask-5.png)
...
![askflowintro](/assets/images/ask-6.png)
...
![askflowintro](/assets/images/ask-7.png)
...
![askflowintro](/assets/images/ask-8.png)


I want to make a post as (id: 12):

![askflowintro](/assets/images/ask-9.png)
...
![askflowintro](/assets/images/ask-10.png)

And voilà, we've made the post!

![askflowintro](/assets/images/ask-11.png)
...
![askflowintro](/assets/images/ask-12.png)
...
![askflowintro](/assets/images/ask-13.png)
![askflowintro](/assets/images/ask-14.png)

And just like that, you're keeping tabs on all the site's activity. Take a look:

![askflowintro](/assets/images/ask-15.png)
